...
def createScene(root):
    ...
    cable0.addObject('MechanicalObject', name = 'cable0MO',
    ...
    number_of_cable_through_points = 14
    cable1.addObject('MechanicalObject', name = 'cable1MO',
                    position=[[0,-0.022*j-0.002,0.04599] for j in range(number_of_cable_through_points)],
                    rotation='0 120 0')
    ...
    number_of_cable_through_points = 14
    cable2.addObject('MechanicalObject', name = 'cable2MO',
                    position=[[0,-0.022*j-0.002,0.04599] for j in range(number_of_cable_through_points)],
                    rotation='0 240 0')
    ...
    wakra.addObject(CableController(name="CableController", wakrabot=wakra, rootnode = root, compressed=initialValue))
...
def main():
    ...
    if not USE_GUI:
        iter = np.loadtxt('./Wakrabot/data_files/divide_tra.csv',delimiter=',').shape[0]
